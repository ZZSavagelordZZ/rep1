...
* @see https://v0.dev/t/YpXEJlUI2AM
    ...
    (<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-primary rounded-lg overflow-hidden mb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center">
          <div className="p-8">
            <h2 className="text-3xl font-bold text-primary-foreground mb-4">Get 20% Off Your Next Rental</h2>
            <p className="text-primary-foreground mb-6">
              New members can save big on their next car rental. Offer ends soon, so don't miss out!
            </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent className="p-6">
              <h3 className="text-xl font-bold mb-2">20% Off Compact Car Rentals</h3>
              <p className="text-muted-foreground mb-4">Rent a compact car and save 20% on your next booking.</p>
              <div className="flex justify-between items-center mb-4">
                <div>
                  <CalendarDaysIcon className="mr-2 h-4 w-4" />
                  <span className="text-sm text-muted-foreground">Expires: 2024-09-30</span>
                </div>
                <Badge variant="secondary">Discount</Badge>
              </div>
              <div className="text-sm text-muted-foreground">
                <p>
                  Offer valid for new members only. Minimum rental period of 3 days. See terms and conditions for
                  details.
                </p>
              </div>
            </CardContent>
